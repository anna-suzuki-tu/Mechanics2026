// Lecture 1 — Gatekeeper Questions
// Source: Gatekeeper DB entries 1-1 through 1-5
const questions = [
  {
    id: "1-1",
    title: "Question 1",
    text: "In a velocity-time (v-t) graph, what does the area under the curve from t1 to t2 represent?",
    choices: [
      "The instantaneous acceleration at t2",
      "The distance traveled (always positive)",
  ...
  },
  {
    id: "1-2",
    title: "Question 2",
    text: "For x = 6t^2 - t^3, which statement is correct?",
    choices: [
      "You can always use v = v0 + at",
      "Acceleration is constant",
      "Acceleration depends on time, so constant-acceleration formulas do not apply",
  ...
  },
  {
    id: "1-3",
    title: "Question 3",
    text: "If velocity is zero at some instant, what must be true about acceleration?",
    choices: [
  ...
  },
  {
    id: "1-4",
    title: "Question 4",
    text: "What does the slope of an x-t graph represent?",
    choices: [
      "Acceleration",
      "Velocity",
      "Displacement",
  ...
  },
  {
    id: "1-5",
    title: "Question 5",
    text: "An object moves in the positive direction, but its speed is decreasing. What is the sign of acceleration?",
    choices: [
      "Positive",
      "Negative",
      "Zero",
